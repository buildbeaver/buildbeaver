...
// a top-level attribute, it should be a single-element cty.Paths with a
...
// GetAttribute extracts an attribute cty.Paths from a diagnostic if it contains
...
// This returns a nil cty.Paths if it does not exist in the Diagnostic.
